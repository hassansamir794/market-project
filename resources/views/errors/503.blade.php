...
@section('title', __('messages.error_503_title') . ' | Rasan Market')
...
@section('content')
    <div class="min-h-[55vh] flex items-center justify-center">
        <div class="glass-card p-8 max-w-xl w-full text-center">
            ...
            <h1 class="mt-2 text-2xl sm:text-3xl font-bold text-gray-900">{{ __('messages.error_503_title') }}</h1>
            <p class="mt-3 text-gray-600">
                {{ __('messages.error_503_text') }}
            </p>
            <div class="mt-6">
